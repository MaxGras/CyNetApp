    ...
    return (
        <div className="h-[80vh] w-full">
            <div className="mx-auto w-[50%]">
                <h4 className="text-[3.5rem] font-[800]"><span className="block">ПОТРІБНА</span> ОНЛАЙН-КОНСУЛЬТАЦІЯ?</h4>
                <p className='  text-[#beb9b9] font-[700] text-3xl'>Заповнюй форму та чекай на відгук:</p>
                <div className="flex flex-col gap-[2vh]  py-[10%]">
                    <div className="bg-[#c9cbd7] w-[250px] h-[50px] rounded-[10px]  "></div>
                    <div className="bg-backgroundConsultDesign rounded-[15px] bg-center  bg-no-repeat bg-cover w-[100%] h-[40vh]"></div>
                    <div></div>
